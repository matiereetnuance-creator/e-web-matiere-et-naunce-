...
| 5 | Menu À propos fonctionne | **Pilotage ▸ ℹ️ À propos…** → boîte affichant "Version : 4.1.3 (Premium)", une date de build, un auteur, "Dernier diagnostic : [date récente]", "Dernière installation : [date récente]" | |
